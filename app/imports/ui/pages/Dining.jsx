...
const Dining = () => (
  <Container>
    ...
    <Row>
      ...
      <Col>
        <Card style={{ width: '18rem' }}>
          <Card.Img variant="top" src="https://upload.wikimedia.org/wikipedia/en/thumb/d/d3/Starbucks_Corporation_Logo_2011.svg/1200px-Starbucks_Corporation_Logo_2011.svg.png" />
          <Card.Body>
      ...
      <Col>
        <Card style={{ width: '18rem' }}>
          <Card.Img variant="top" src="https://www.jamba.com/-/media/jamba/site-logos/jamba-logo.jpg?v=1&d=20190608T213113Z" />
          <Card.Body>
      ...
      <Col>
        <Card style={{ width: '18rem' }}>
          <Card.Img variant="top" src="https://manoa.hawaii.edu/studentlife/wp-content/uploads/brizy/imgs/food-court-216x145x0x0x216x144x1659491587.jpg" />
          <Card.Body>
    ...
    <Row>
      ...
      <Col>
        <Card style={{ width: '18rem' }}>
          <Card.Img variant="top" src="https://manoa.hawaii.edu/food/wp-content/uploads/sites/37/2020/05/dunkin_logo.png" />
          <Card.Body>
      ...
      <Col>
        <Card style={{ width: '18rem' }}>
          <Card.Img variant="top" src="https://manoa.hawaii.edu/food/wp-content/uploads/sites/37/2022/10/holoholob_logo.png" />
          <Card.Body>
      ...
      <Col>
        <Card style={{ width: '18rem' }}>
          <Card.Img variant="top" src="https://manoa.hawaii.edu/food/wp-content/uploads/sites/37/2020/05/landl_logo.png" />
          <Card.Body>
      ...
      <Col>
        <Card style={{ width: '18rem' }}>
          <Card.Img variant="top" src="https://manoa.hawaii.edu/food/wp-content/uploads/sites/37/2020/05/lecrepe_logo.png" />
          <Card.Body>
      ...
      <Col>
        <Card style={{ width: '18rem' }}>
          <Card.Img variant="top" src="https://manoa.hawaii.edu/food/wp-content/uploads/sites/37/2020/05/lasoon_logo.png" />
          <Card.Body>
      ...
      <Col>
        <Card style={{ width: '18rem' }}>
          <Card.Img variant="top" src="https://manoa.hawaii.edu/food/wp-content/uploads/sites/37/2020/05/panda_logo.png" />
          <Card.Body>
    ...
    <Row>
      ...
      <Col>
        <Card style={{ width: '18rem' }}>
          <Card.Img variant="top" src="https://content-service.sodexomyway.com/media/MDS%20GIF2_tcm247-17796.png?url=https://uhm.sodexomyway.com/" />
          <Card.Body>
